...
<%
    ...
    ResultSet rs=st.executeQuery("select * from studentm inner join studentr where studentm.rollnumber=studentr.rollnumber and studentm.rollnumber='"+rollnumber+"'");
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <thead>
        <tr>
          ...
          <th><center>RollNo: <% rs.getInt(3); %></center></th>
        </tr>
      </thead>
      <thead>
        <tr>
