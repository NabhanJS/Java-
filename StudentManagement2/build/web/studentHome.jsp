...
<% 
    ...
    ResultSet rs=st.executeQuery("select * from smanagement inner join sresult where studentmanagement2.rollnumber=sresult.rollnumber and studentmanagement2.rollnumber='"+rollNumber+"'");
