...
<section>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
            <%@page import="studentmanagement2.util.DBConnection"  %>
            <%@page import="java.sql.*"  %>
            <% 
            
            Statement pst=DBConnection.getCon().createStatement();
            ResultSet rs=pst.executeQuery("select * from smanagement");
            while (rs.next()){
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
         <%@page import="studentmanagement2.util.DBConnection"  %>
            ...
            ResultSet rs1=pst1.executeQuery("select * from sresult");
            while (rs1.next()){
