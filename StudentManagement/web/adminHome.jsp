                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertResult.jsp" method="">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="enggPhysics1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="enggChemistry">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="enggMathematics1">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="basicElectricalEngg">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="electronicEngg">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text"  class="form-control" name="enggChemistryLab">
                                    </div>
                                </div>
                                 ...
                                 <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="enggPhysicsLab">
                                    </div>
                                </div>
  ...
  <div class="tbl-content">
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
            ...
            <%@page import="studentManagement.util.DBConnection"  %>
            <%@page import="java.sql.*"  %>
            <% 
            
            Statement pst=DBConnection.getCon().createStatement();
            ResultSet rs=pst.executeQuery("select * from studentmanagement");
            while (rs.next()){
    ...
    <table cellpadding="0" cellspacing="0" border="0">
      <tbody>
        ...
        <%@page import="java.sql.*"  %>
            ...
            Statement pst1=DBConnection.getCon().createStatement();
            ResultSet rs1=pst1.executeQuery("select * from result");
            while (rs1.next()){
