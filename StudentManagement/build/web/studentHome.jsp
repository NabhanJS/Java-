...
<% 
   try{
    ...
    ResultSet rs=st.executeQuery("select * from studentmanagement inner join result where studentmanagement.rollNumber=result.rollNumber and studentmanagement.rollNumber='"+rollNumber+"'");
    if(rs.next()){
  ...
  <table>
    ...
    <tfoot>
      <tr>
        ...
        <td>560</td>
        <td>180</td>
        <td><% int sum=rs.getInt(9) + rs.getInt(10) + rs.getInt(11) + rs.getInt(12) + rs.getInt(13) + rs.getInt(14) + rs.getInt(15); %> </td>
      </tr>
      <tr>
        <td colspan="4" class="footer">Percentage</td>
        
        <td colspan="4"><% out.print((sum*100)/560); %></td>
      </tr>
  </table>
    <hr class="new1">
